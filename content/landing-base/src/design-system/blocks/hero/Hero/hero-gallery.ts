...
// hero/Hero/default and hero/Hero/split.
//
...
//
// Composition is still gated: both variants declare `product.gallery` in
 ...
 */
export function heroGallery(_variant: 'default' | 'split'): MediaRef[] {
